...
(4/4). `conform --target rust` is now **1 of 9 failing** — only generated
round-trip tests remain before it flips green + into the CI gate. **Then M6 — TypeScript (v4)**
