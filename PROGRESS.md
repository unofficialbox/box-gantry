...
**~86% complete by effort** — **v1 (Go SDK) is shipped**; v2 (Apex) is
...
live-smoke run + the release tag (a pipeline action, as with Go's tag). The large shared cost — the whole
