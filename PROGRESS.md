...
faked exclusions) that joins the release gate once those land. Next slices:
pagination `Stream`s, typed date/time, and generated tests + docs (which flip
`conform --target rust` green). **Then M6 — TypeScript (v4)**
