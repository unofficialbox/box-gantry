...
climbed back to ~91% as v3 reached parity and v4's model layer, managers/client,
runtime (all four auth flows), conformance, and reference docs landed — and
adding **Java 26 as a fifth target (D-164)** now steps it down again from ~91% to
~83% (again, no completed work lost). The large shared cost — the whole
...
| v3 — Rust 🦀 | 380 | 132 | ~72% |
| v4 — TypeScript 🟦 | 320 | 96 | ~56% |
| v5 — Java 26 ☕ | 360 | 108 | 0% |
| **Total** | **3,790** | **1,160** | **~83%** |
