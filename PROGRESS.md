...
**~85% complete by effort** — **v1 (Go SDK) is shipped**; v2 (Apex) is
...
and loads through both `import` and `require` — is built and gated (D-167). Only
VR-7 live smoke remains for a fully shipped v4. The large shared cost — the whole
...
| v3 — Rust 🦀 | 380 | 132 | ~72% |
| v4 — TypeScript 🟦 | 320 | 96 | ~82% |
| v5 — Java 26 ☕ | 360 | 108 | 0% |
| **Total** | **3,790** | **1,160** | **~85%** |
