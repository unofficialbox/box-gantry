...
/// `base64` dependency encodes the Box `Digest` header. Parts upload in
/// sequence — concurrent upload would need a `futures`/`tokio` `rt` dependency
/// the SDK deliberately avoids.
