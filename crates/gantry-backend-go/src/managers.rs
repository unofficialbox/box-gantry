...
use crate::{MODULE, RUNTIME_IMPORT, SERIALIZATION_IMPORT};
...
impl ManagerPrinter<'_> {
    ...
    fn manager(&mut self, manager: &str, op_indices: &[usize]) -> Result<(), BackendError> {
        ...
        self.imports.insert(RUNTIME_IMPORT.to_string());
    ...
    fn go_type(&mut self, ty: &ir::Type) -> Result<String, BackendError> {
        match ty {
            ...
            ir::Type::Date => {
                self.imports.insert(SERIALIZATION_IMPORT.to_string());
    ...
    fn qualified_decl(&mut self, id: ir::DeclId) -> String {
        ...
        self.imports
            .insert(format!("{MODULE}/{}", segments.join("/")));
