...
pub fn generate_models(analysis: &Analysis<'_>, build: &BuildInfo) -> Vec<GeneratedFile> {
    ...
    // The barrel re-exports each module as a namespace, so names that collide
    // across API versions (`ClientError` in the base and in 2025.0) stay
    // distinct — `models.schemas.ClientError` vs `models.schemas_v2025_0.…`.
